...
const realistic = (): Cv => {
  const cv = defaultCv()
  cv.personal = {
    firstName: 'Bogdan', lastName: 'Dinu', headline: 'Fullstack Developer',
    location: 'Bucharest, Romania', email: 'bogdanradu.dinu@infosys.com',
  ...
  cv.qualifications = [
    ...
    { id: 'q2', institution: 'Faculty of Political Sciences (SNSPA), Bucharest', degree: 'Masters in Anthropology (not graduated)', field: '', location: '', startDate: '', endDate: '', grade: '' },
  ]
  ...
  cv.experience = [
    { id: 'e1', company: 'United Nations Office at Geneva (ITBAU)', position: 'Senior Drupal Developer', location: '', startDate: '2019-04', endDate: '', current: true, tech: [],
    ...
    { id: 'e2', company: 'Kubis Interactive, Bucharest, Romania', position: 'Senior Fullstack Web Developer', location: '', startDate: '2012-01', endDate: '2019-03', current: false, tech: [],
  ...
  cv.certifications = [
    { id: 'c1', name: 'Certified Drupal 11 Developer', issuer: '', date: '', expiryDate: '', credentialUrl: '' },
    { id: 'c2', name: 'Certified Drupal 9 Site Builder', issuer: '', date: '', expiryDate: '', credentialUrl: '' },
  ]
  cv.languages = [
  ...
  cv.projects = [
    { id: 'p1', name: 'UN Geneva Design System', role: '', description: richTextFromPlain('Starting from the new theme for the ungeneva.org website I created a starterkit theme that was later used on all ITBAU Drupal projects.', 'paragraph'), tech: [], url: '', startDate: '', endDate: '' },
  ]
  return cv
}
