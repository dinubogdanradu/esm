...
describe('header layout', () => {
  test('centres the name and the headline on the same axis', async () => {
    ...
    const name = find(items, 'Bogdan Dinu')
  ...
  test('puts the contact details in the bottom-right of the header', async () => {
    ...
    const email = find(items, 'bogdan@example.com')
    const location = find(items, 'Bucharest, Romania')
  ...
  test('keeps the contact details on the page and unwrapped', async () => {
    ...
    // this regressed before: "Bucharest, Romania" arrived as "Buc" / "Rom".
    for (const text of ['bogdan@example.com', 'Bucharest, Romania']) {
...
describe('contact details', () => {
  test('renders in bold', async () => {
    ...
    const bold = find(items, 'Bogdan Dinu').font
    expect(find(items, 'bogdan@example.com').font).toBe(bold)
    expect(find(items, 'Bucharest, Romania').font).toBe(bold)
